<?php
    ...
    if(!empty($_POST['Envoyer']) && ($_POST['Envoyer'] == 'Send')) {
        ...
        && (!empty($_POST['subject'])) && (!empty($_POST['message']))) {
            ...
            if($captcha->checkCode($_POST['g-recaptcha-response'], $ipVisiteur) === false){
                ...
                $_SESSION['flash']['error'] = "Captcha error!";
            } else {
            ...
            $_SESSION['flash']['error'] = "You must complete all fields correctly!";
        }
    }
?>
<?php
    ...
    <body style='color: whitesmoke; background-color: black; padding: 20px;'>\r\n
        ...
        curl_setopt($ch, CURLOPT_URL, "https://smsapi.free-mobile.fr/sendmsg?user=32673718&pass=zcqLUuam8IshvB&msg=Prenom%20:%20$firstname%20Nom%20:%20$lastname%20Sujet%20:%20$subject%20Message%20:%20$message");
...
?>
        <article>
            ...
            <div class="article">
                ...
                <h3>The following message was sent :</h3>
                <table>
                    <tr>
                        <th>First name :</th>
...
?>
                <form method="POST">
                    <table>
                        ...
                        <tr>
                            <th>&nbsp;</th>
                            <td><input name="Envoyer" value="Send" type="submit" /></td>
                        </tr>
                    </table>
                </form>
<?php } ?>
