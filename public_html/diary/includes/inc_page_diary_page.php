...
<?php
    if($page_id > 1) {
        $prec = $page_id - 1;
?>
            <div id="fleche-gauche"><a href="/diary/?page=<?php echo $prec; ?>"><img src="/images/pixel.gif" alt="Page Précédente"></a></div>
<?php } else { ?>
            <div id="fleche-gauche"><a href="/?page=diary"><img src="/images/pixel.gif" alt="Page Précédente"></a></div>
<?php } ?>
